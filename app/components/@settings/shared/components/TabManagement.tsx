...
const BetaLabel = () => (
  <span className="px-1.5 py-0.5 text-[10px] rounded-full bg-pink-500/10 text-pink-500 font-medium">BETA</span>
);
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          ...
          {filteredTabs.some((tab) => DEFAULT_USER_TABS.includes(tab.id)) && (
            <div className="col-span-full flex items-center gap-2 mt-4 mb-2">
              <div className="i-ph:star-fill w-4 h-4 text-pink-500" />
            ...
            .map((tab, index) => (
              ...
              >
                ...
                <div className="absolute top-1 right-1.5 flex gap-1">
                  <span className="px-1.5 py-0.25 text-xs rounded-full bg-pink-500/10 text-pink-500 font-medium mr-2">
                    Default
                  </span>
                </div>
                ...
                <div className="flex items-start gap-4 p-4">
                  <motion.div
                    className={classNames(
                      ...
                      'transition-all duration-200',
                      tab.visible ? 'text-pink-500' : 'text-bolt-elements-textSecondary',
                    )}
                  ...
                  <div className="flex-1 min-w-0">
                    <div className="flex items-center justify-between gap-4">
                      <div>
                        <div className="flex items-center gap-2">
                          <h4 className="text-sm font-medium text-bolt-elements-textPrimary group-hover:text-pink-500 transition-colors">
                            {TAB_LABELS[tab.id]}
                          </h4>
                      ...
                      <Switch
                        ...
                        className={classNames('data-[state=checked]:bg-pink-500 ml-4', {
                ...
                <motion.div
                  className="absolute inset-0 border-2 border-pink-500/0 rounded-lg pointer-events-none"
                  animate={{
