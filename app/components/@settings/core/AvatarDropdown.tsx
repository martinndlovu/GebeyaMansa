...
const BetaLabel = () => (
  <span className="px-1.5 py-0.5 rounded-full bg-pink-500/10 dark:bg-pink-500/20 text-[10px] font-medium text-pink-600 dark:text-pink-400 ml-2">
    BETA
  </span>
);
    ...
    <DropdownMenu.Root>
      ...
      <DropdownMenu.Portal>
        ...
        >
          ...
          >
            <div className="i-ph:user-circle w-4 h-4 text-gray-400 group-hover:text-pink-500 dark:group-hover:text-pink-400 transition-colors" />
            Edit Profile
          </DropdownMenu.Item>
          ...
          >
            <div className="i-ph:gear-six w-4 h-4 text-gray-400 group-hover:text-pink-500 dark:group-hover:text-pink-400 transition-colors" />
            Settings
          </DropdownMenu.Item>
          ...
          >
            <div className="i-ph:activity w-4 h-4 text-gray-400 group-hover:text-pink-500 dark:group-hover:text-pink-400 transition-colors" />
            Task Manager
            <BetaLabel />
          </DropdownMenu.Item>
          ...
          >
            <div className="i-ph:heartbeat w-4 h-4 text-gray-400 group-hover:text-pink-500 dark:group-hover:text-pink-400 transition-colors" />
            Service Status
            <BetaLabel />
          </DropdownMenu.Item>
        </DropdownMenu.Content>
